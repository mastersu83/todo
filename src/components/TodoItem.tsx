...
export const TodoItem = ({
  ...
  return (
    <Flex
      ...
      justify="center"
      className={cn(
        // deleteAnimation ? "bg-red-400" : "",
        "h-full rounded-lg transition duration-150 relative"
      )}
    >
      <motion.div
        ...
        animate={{
          ...
          x:
            isDeleting || (isChangeStatus && activeTab)
              ? 100
              : deleteAnimation
              ? -85
              : 0,
          ...
          <Flex justify="between" align="center">
            ...
            <Flex gap="3" justify="between" align="center" width="100%">
              ...
              <Flex gap="3" justify="center" align="center">
                ...
                <motion.div
                  onClick={() => setDeleteAnimation(!deleteAnimation)}
                  animate={{
      ...
      <motion.button
        ...
        transition={{ duration: 0.5 }}
        className={cn(
          "px-2 py-5 rounded-lg text-white cursor-pointer font-bold bg-red-400 absolute top-0 right-0"
        )}
      >
        Удалить
      </motion.button>
